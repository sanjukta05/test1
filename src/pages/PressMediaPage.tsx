...
const PressMediaPage = () => {
  ...
  return <div className="min-h-screen flex flex-col">
      <Navigation />
      <PageHeader title="Press & Media." description="Latest News, Media Coverage, and Resources." backgroundImage="/lovable-uploads/8d1007c1-5891-4364-91c8-7a6972b3d8fc.png" />
      
      <main className="flex-grow">
        <section className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto mb-16">
              <h2 className="text-3xl mb-6 text-center font-normal md:text-5xl">Latest Press Releases.</h2>
              <p className="text-center text-deco-plum/80 text-xl">
                Stay updated with the latest announcements from DecoPaints UAE.
              </p>
            </div>
            
            <div className="space-y-8 max-w-6xl mx-auto">
              {pressReleases.map(item => <Card key={item.id} className="overflow-hidden hover:shadow-md transition-shadow">
                  <CardContent className="p-6">
                    ...
                    <div className="flex justify-end">
                      <a href={`/press/${item.id}`} className="text-deco-denim hover:text-deco-plum transition-colors inline-flex items-center">
            ...
            <div className="max-w-4xl mx-auto text-center mt-12">
              <a href="/press-archive" className="border border-deco-plum hover:bg-deco-plum hover:text-white text-deco-plum font-medium py-2 px-6 rounded-full transition-colors inline-block">
                View Press Archive
              </a>
            </div>
          </div>
        ...
        <section className="py-16 md:py-24 bg-deco-beige">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto mb-16">
              <h2 className="text-3xl mb-6 text-center font-normal md:text-5xl">Media Features.</h2>
              <p className="text-center text-deco-plum/80 text-xl">
              ...
              {mediaFeatures.map(feature => 
                <div key={feature.id} className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                  ...
                  <div className="p-6">
                    ...
                    <a href={`/media/${feature.id}`} className="text-deco-denim hover:text-deco-plum transition-colors inline-flex items-center">
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto mb-16">
              <h2 className="text-3xl mb-6 text-center font-normal md:text-5xl">Awards &amp; Recognition.</h2>
              <p className="text-center text-deco-plum/80 text-xl">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
              {awardRecognitions.map((award, index) => <div key={index} className="bg-deco-beige p-6 rounded-lg">
        ...
        <section className="py-16 md:py-24 bg-deco-beige">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl mb-6 font-normal md:text-5xl">Media Resources.</h2>
              <p className="mb-12 text-deco-plum/80 text-xl">
              ...
              <div className="grid md:grid-cols-3 gap-8 max-w-3xl mx-auto mb-12">
                <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                  ...
                  <a href="/media-resources/images" className="text-deco-denim hover:text-deco-plum transition-colors text-sm">
                    Browse Images
                  </a>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                  ...
                  <a href="/media-resources/press-kit" className="text-deco-denim hover:text-deco-plum transition-colors text-sm">
                    Download Press Kit
                  </a>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                  ...
                  <a href="/media-resources/events" className="text-deco-denim hover:text-deco-plum transition-colors text-sm">
                    View Calendar
                  </a>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md max-w-2xl mx-auto">
                <h3 className="mb-4 font-medium text-5xl">Media Contact.</h3>
                <p className="text-deco-plum/80 mb-6 text-xl">
        ...
        <section className="py-16 md:py-24 bg-deco-plum text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl mb-6 font-normal md:text-5xl">Press &amp; Media Inquiries.</h2>
