    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <h2 className="text-3xl md:text-4xl font-bold mb-6">Our Abu Dhabi Location</h2>
                  <p className="text-deco-plum/80 mb-6">
                    Serving the capital with premium decorative finishing solutions for residential and commercial properties
                    throughout Abu Dhabi. Visit our showroom to explore our full range of decorative paints and flooring solutions.
                  </p>
                  ...
                  <div className="space-y-4 mb-8">
                    <div className="flex items-start">
                      ...
                      <address className="not-italic text-deco-plum/80">
                        Khalifa St, Al Bateen, Abu Dhabi
                      </address>
                    </div>
                    
                    <div className="flex items-start">
                      <Phone className="h-5 w-5 mr-3 text-deco-gold" />
                      <a href="tel:+971504118372" className="text-deco-denim hover:text-deco-plum transition-colors">
                        +971 50 411 8372
                      </a>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <a href="mailto:abudhabi@decopaints.ae" className="text-deco-denim hover:text-deco-plum transition-colors">
                        abudhabi@decopaints.ae
                      </a>
                    </div>
                  </div>
                ...
                <div>
                  <div className="rounded-lg overflow-hidden shadow-lg h-96">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3631.2578012650224!2d54.35483651499573!3d24.46651618424865!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5e661b857a0eeb%3A0xf3d20ea13c2634d9!2sAbu%20Dhabi!5e0!3m2!1sen!2sae!4v1652180684476!5m2!1sen!2sae" 
                      width="100%" 
                      height="100%" 
                      style={{ border: 0 }} 
                      allowFullScreen 
                      loading="lazy"
                      aria-label="Map showing Abu Dhabi DecoPaints location"
                    ></iframe>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center">Abu Dhabi Experience Center</h2>
              <p className="text-center mb-12 max-w-3xl mx-auto text-deco-plum/80">
                Visit our Abu Dhabi Experience Center to see and feel our premium decorative finishes firsthand. Our design consultants will guide you 
