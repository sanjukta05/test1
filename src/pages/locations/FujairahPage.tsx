...
const FujairahPage = () => {
  useEffect(() => {
    document.title = "Fujairah's Best Decorative Paints & Flooring Company | DecoPaints";
  }, []);
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Navigation />
      <PageHeader 
        title="Fujairah's Best Decorative Paints & Flooring Company"
        description="Premium decorative finishes for Fujairah's coastal properties"
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <h2 className="text-3xl md:text-4xl font-bold mb-6">Our Fujairah Location</h2>
                  <p className="text-deco-plum/80 mb-6">
                    Bringing our artisanal finishes to the eastern coast, specialized in solutions for the coastal environment.
                    Our marine-grade finishes are formulated to withstand Fujairah's unique coastal conditions while maintaining their beauty.
                  </p>
                  ...
                  <div className="space-y-4 mb-8">
                    <div className="flex items-start">
                      ...
                      <address className="not-italic text-deco-plum/80">
                        Hamad Bin Abdullah Rd, Fujairah City
                      </address>
                    </div>
                    
                    <div className="flex items-start">
                      <Phone className="h-5 w-5 mr-3 text-deco-gold" />
                      <a href="tel:+971508117045" className="text-deco-denim hover:text-deco-plum transition-colors">
                        +971 50 811 7045
                      </a>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <a href="mailto:fujairah@decopaints.ae" className="text-deco-denim hover:text-deco-plum transition-colors">
                        fujairah@decopaints.ae
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    <a href="https://wa.me/971508117045">
                      <Button className="bg-deco-denim hover:bg-deco-denim/90">
                        WhatsApp Inquiry
                      </Button>
                    </a>
                ...
                <div>
                  <div className="rounded-lg overflow-hidden shadow-lg h-96">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3598.9883846586537!2d56.33002841501975!3d25.568982983764933!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef4549dfb34698d%3A0x66a2fcd9d986398!2sFujairah!5e0!3m2!1sen!2sae!4v1652180904476!5m2!1sen!2sae"
                      width="100%" 
                      height="100%" 
                      style={{ border: 0 }} 
                      allowFullScreen 
                      loading="lazy"
                      aria-label="Map showing Fujairah DecoPaints location"
                    ></iframe>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16 bg-deco-beige">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center">Fujairah Districts We Serve</h2>
              <p className="text-center mb-12 max-w-3xl mx-auto text-deco-plum/80">
                Our expert team provides premium decorative finishing services throughout Fujairah, with specialized 
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {districts.map(district => (
                  <Link 
                    key={district.name} 
                    to={`/locations/fujairah/${district.slug}`}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center">Fujairah Experience Center</h2>
              <p className="text-center mb-12 max-w-3xl mx-auto text-deco-plum/80">
                Visit our Fujairah Experience Center to see and feel our premium decorative finishes firsthand. Our design consultants will guide you 
