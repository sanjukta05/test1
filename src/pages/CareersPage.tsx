...
const CareersPage = () => {
  ...
  const jobs = [
    {
      ...
      requirements: [
        "5+ years experience in premium decorative finishing",
        "Portfolio showcasing Venetian plaster, Marmorino, and textured finishes",
        "Excellent attention to detail and color matching abilities",
        "Strong work ethic and ability to work in team environments",
        "Experience working in luxury residential and commercial projects"
      ]
    },
    {
      ...
      requirements: [
        "Background in architecture, interior design, or related field",
        "Minimum 3 years experience in architectural sales or specifications",
        "Strong knowledge of decorative finishes and their applications",
        "Excellent presentation and communication skills",
        "Established network within UAE design community preferred"
      ]
    },
    {
      ...
      requirements: [
        "3+ years experience installing specialty flooring systems",
        "Proficiency in micro-cement, terrazzo, and epoxy applications",
        "Meticulous surface preparation and finishing skills",
        "Understanding of substrate requirements and moisture testing",
        "Experience with complex pattern work and decorative techniques"
      ]
    }
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <PageHeader 
        title="Join Our Team"
        description="Build Your Career with UAE's Premier Decorative Finishing Company"
        backgroundImage="https://images.unsplash.com/photo-1541746972996-4e0b0f43e02a?auto=format&fit=crop&q=80&w=2000&h=600"
      />
      ...
      <main className="flex-grow">
        <section className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center">Why Work With Us</h2>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mt-16 text-center">
                ...
                <a 
                  href="/contact" 
                  className="border border-deco-plum hover:bg-deco-plum hover:text-white text-deco-plum font-medium py-3 px-8 rounded-full transition-colors inline-block"
                >
        ...
        <section className="py-16 md:py-24 bg-deco-beige">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">Life at DecoPaints</h2>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div>
                <img 
                  src="https://images.unsplash.com/photo-1520333789090-1afc82db536a?auto=format&fit=crop&q=80&w=600&h=400" 
                  alt="Team workshop" 
