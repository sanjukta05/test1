...
const GetEstimateMobileButton: React.FC = () => {
  ...
  return <button type="button" onClick={openForm} className="fixed left-4 bottom-6 z-40 bg-deco-plum text-white py-4 rounded-full shadow-lg hover:shadow-xl transition-all group flex items-center gap-2 block md:hidden px-[12px]">
