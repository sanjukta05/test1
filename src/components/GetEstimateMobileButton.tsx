...
const GetEstimateMobileButton: React.FC = () => {
  ...
  return (
    <button
      type="button"
      className="fixed left-4 bottom-6 z-40 bg-deco-denim text-white px-6 py-4 rounded-full shadow-lg hover:shadow-xl transition-all group flex items-center gap-2 block md:hidden"
      onClick={openForm}
    >
