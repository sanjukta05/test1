      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="flex flex-col items-center text-center bg-white p-8 rounded-lg shadow-sm">
            ...
            <h3 className="font-parafina text-xl font-bold mb-2">Premium Quality</h3>
          ...
          <div className="flex flex-col items-center text-center bg-white p-8 rounded-lg shadow-sm">
            ...
            <h3 className="font-parafina text-xl font-bold mb-2">5-Year Warranty</h3>
            <p className="text-deco-plum/80">
          ...
          <div className="flex flex-col items-center text-center bg-white p-8 rounded-lg shadow-sm">
            ...
            <h3 className="font-parafina text-xl font-bold mb-2">Client Satisfaction</h3>
            <p className="text-deco-plum/80">
